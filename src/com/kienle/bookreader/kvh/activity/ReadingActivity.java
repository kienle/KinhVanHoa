package com.kienle.bookreader.kvh.activity;
...
import com.kienle.bookreader.kvh.Configuration;
import com.kienle.bookreader.kvh.Configuration.AnimationStyle;
import com.kienle.bookreader.kvh.Configuration.ColourProfile;
import com.kienle.bookreader.kvh.R;
import com.kienle.bookreader.kvh.animation.Animations;
import com.kienle.bookreader.kvh.animation.Animator;
import com.kienle.bookreader.kvh.animation.PageCurlAnimator;
import com.kienle.bookreader.kvh.library.LibraryService;
import com.kienle.bookreader.kvh.selection.SelectionPointerImageView;
import com.kienle.bookreader.kvh.selection.SelectionWord;
import com.kienle.bookreader.kvh.selection.TextSelection;
import com.kienle.bookreader.kvh.view.AnimatedImageView;
import com.kienle.bookreader.kvh.view.BookView;
import com.kienle.bookreader.kvh.view.BookViewListener;
import com.kienle.bookreader.kvh.view.NavGestureDetector;
...
//	private static final String INTERNAL_PATH =  "files";
	//private static final String TEST_EPUB_FILE_NAME ="/mnt/sdcard/KVH_02.epub";
	private final String FILE_PATH =  Environment.getRootDirectory().getAbsolutePath();
...
//		requestWindowFeature(Window.FEATURE_NO_TITLE);
		...
		this.gestureDetector = new GestureDetector(this, new NavGestureDetector(this.bookView, this, metrics));
    	...
    	Log.d("KienLT", "file path = " + Environment.getRootDirectory().getAbsolutePath());
    	Log.d("KienLT", "file path = " + FILE_PATH);
    	
    	this.registerForContextMenu(this.bookView);
		this.updateFromPrefs();
		this.updateFileName(savedInstanceState, FILE_PATH + LibraryActivity.file_epub_name);  		
			
    	if ((FILE_PATH + LibraryActivity.file_epub_name).equals("")) {
...
//				break;
	...
	protected void onSaveInstanceState(Bundle outState) {
		if (this.bookView != null) {
			...
			this.libraryService.updateReadingProgress(FILE_PATH + LibraryActivity.file_epub_name, this.progressPercentage);
...
//			});
	...
	private void updateFileName(Bundle savedInstanceState, String fileName) {
		...
		fileName = FILE_PATH + LibraryActivity.file_epub_name ;
	...
	private void updateFromPrefs() {
        ...
        if ( config.isBrightnessControlEnabled() != oldBrightness
        	...
        	intent.setData(Uri.parse(FILE_PATH + LibraryActivity.file_epub_name));
		...
		this.backgroundHandler.post(new Runnable() {
			...
			public void run() {
				try {
					...
					//libraryService.storeBook(INTERNAL_PATH+LibraryActivity.file_epub_name, book, true, config.isCopyToLibrayEnabled() );
					libraryService.storeBook(FILE_PATH + LibraryActivity.file_epub_name, book, true,true);
				} catch (IOException e) {
