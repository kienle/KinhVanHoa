...
import com.kienle.bookreader.kvh.Configuration.LibrarySelection;
import com.kienle.bookreader.kvh.Configuration.LibraryView;
import com.kienle.bookreader.kvh.R;
import com.kienle.bookreader.kvh.library.ImportCallback;
import com.kienle.bookreader.kvh.library.ImportTask;
import com.kienle.bookreader.kvh.library.KeyedQueryResult;
import com.kienle.bookreader.kvh.library.KeyedResultAdapter;
import com.kienle.bookreader.kvh.library.LibraryBook;
import com.kienle.bookreader.kvh.library.LibraryService;
import com.kienle.bookreader.kvh.library.QueryResult;
import com.kienle.bookreader.kvh.quickaction.LibraryQuickAction;
import com.kienle.bookreader.kvh.view.BookCaseView;
import com.kienle.bookreader.kvh.view.FastBitmapDrawable;
...
public class LibraryActivity extends RoboSherlockActivity implements ImportCallback, OnItemClickListener {
	...
	public static String file_epub_name="";
	...
	private void onBookClicked(LibraryBook book) {
		...
		String[] arr = book.getFileName().split("/");
		file_epub_name=arr[arr.length-1];
	...
	private void startImport(File startFolder, boolean copy) {
		...
		try {
			...
			String[] filelist = aMan.list("data");
				        
			for (String name : filelist) {
				 Log.d("KienLT", "fileName = " + name);		
				//get file form assets
				InputStream is = getAssets().open("data/"+name);
				//check size
			...
			Log.e("FILE--------------------->", "Not okkkkkkkkkkkkkkkkkk");
		}
...
//					//startImport(new File(getApplicationContext().getFilesDir()+"/KVH_01.epub"), copyToLibCheckBox.isChecked());
//					//startImport(new File(getApplicationContext().getFilesDir()+"/KVH_02.epub"),true);
//					//////////////////////////////////////////////////////////////////////////
//					
//					
//					
	...
	private class LoadBooksTask extends AsyncTask<Configuration.LibrarySelection, Integer, QueryResult<LibraryBook>> {
		...
		protected void onPostExecute(QueryResult<LibraryBook> result) {
			...
			if (librarySelection == Configuration.LibrarySelection.LAST_ADDED && result.getSize() == 0 && !askedUserToImport) {
				...
				startImport(new File(getApplicationContext().getFilesDir().toString()),true);
			}
		}
	}
